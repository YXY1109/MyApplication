...
public final class ActivitySecondBinding implements ViewBinding {
  ...
  private ActivitySecondBinding(@NonNull LinearLayout rootView, @NonNull ImageView goTo) {
  ...
  public static ActivitySecondBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.go_to;
      ImageView goTo = rootView.findViewById(id);
      if (goTo == null) {
        break missingId;
      }

      return new ActivitySecondBinding((LinearLayout) rootView, goTo);
    }
